...
root.title("Medicinal Plant Classifictaion and Plant Prescription ")
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir=r'C:/Users/vinit/Downloads/medicinal_plant_disease_cnn 100% code/medicinal_plant_disease_cnn', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
